...
B.position(400,100)
C=createElement("h2")
C.html("Q2) Who is the president of China")
C.position(50,200)
D=createElement("h2")
D.html("a) Pranab Mukherjee")
D.position(50,250)
E=createElement("h2")
...
function logic4(){
    ...
    S.position(100,300)
    E=createElement("h2")
    E.html("Q2) (d) Xi Jinping")
    E.position(100,350)
    D=createElement("h1")
    D.html("THANK YOU FOR SHARING YOUR TIME")
    D.position(50,500)
    }
